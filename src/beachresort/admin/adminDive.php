...
<body>
    ...
    if (isset($_GET['del'])) {
        $dive = mysqli_fetch_array($diveRepo->findById($_GET['del']));
        unlink('S:/_Ky5/PHP' . $dive['img']);
        echo $dive['img'];

        $diveRepo->deleteById($_GET['del']);
            ...
            <div id="contents">
                <div class="box">
                    <div class="w-[860px]">
                        <div id=" " class="body">
                            <h1>Rooms</h1>
                            <a href="./pages/CUDive.php" class='mr-5 rounded-md
                                px-6 py-[6px] font-bold bg-cyan-400 color-white hover:bg-cyan-300
                                transition-all duration-300' name='submit' name='createRoom'>Create new Dive</a>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="border border-slate-500">
                                                <a class="px-[5px] py-[3px] bg-slate-400" href="<?php echo './pages/CUDive.php?upd=' . $c['id'] ?>">Update</a>
