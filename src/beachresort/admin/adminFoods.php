...
<body>
    ...
    if (isset($_GET['del'])) {
        $food = mysqli_fetch_array($foodsRepo->findById($_GET['del']));
        unlink('S:/_Ky5/PHP' . $food['img']);

        $foodsRepo->deleteById($_GET['del']);
            ...
            <div id="contents">
                <div class="box">
                    <div class="w-[860px]">
                        <div id=" " class="body">
                            <h1>Rooms</h1>
                            <a href="./pages/CUFoods.php" class='mr-5 rounded-md
                                px-6 py-[6px] font-bold bg-cyan-400 color-white hover:bg-cyan-300
                                transition-all duration-300' name='submit' name='createRoom'>Create new Foods</a>
                            <table class='border border-slate-500 mt-5 w-full'>
                                <thead>
                                    <tr '>
                                        <th class="w-[31px] border border-slate-500">id</th>
                                        <th class="w-[31px] border border-slate-500">category</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="border border-slate-500"><?php echo $c['category'] ?></td>
                                            ...
                                            <td class="border border-slate-500">
                                                <a class="px-[5px] py-[3px] bg-slate-400" href="<?php echo './pages/CUFoods.php?upd=' . $c['id'] ?>">Update</a>
